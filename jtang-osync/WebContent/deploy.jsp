				...
				<div class="col-md-3">
					<div class="todo">
						...
						<ul>
							...
							<li class="todo-done" id="deploy_id">
						...
						<div class="row" style="margin-top: 10px;">
							<div class="col-md-6">
								...
								<form class="form-horizontal" role="form">
									...
									<div class="form-group">
										<label for="sUserName" class="col-sm-2 control-label" style="padding-left: 0px;padding-right: 0px;">用户名</label>
										<div class="col-sm-10">
							...
							<div class="col-md-6">
								...
								<form class="form-horizontal" role="form">
									...
									<div class="form-group">
										<label for="dUserName" class="col-sm-2 control-label" style="padding-left: 0px;padding-right: 0px;">用户名</label>
										<div class="col-sm-10">
